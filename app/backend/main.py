...
# Load existing models from the file system

def load_models_from_filesystem():

    """Load existing models from the file system."""

    global models

    models_dir = os.path.join("app", "data", "models")
...
async def list_models():
    ...
    # Reload models from filesystem to ensure we have the latest
